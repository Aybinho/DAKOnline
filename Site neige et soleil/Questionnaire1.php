...
<html>
	<head>
		...
		<meta charset="utf-8">
		<link rel="stylesheet" href="css/stylesquestionnaire.css"/>
		...
		<h1> Neige et Soleil</h1>
			...
			<nav>
				...
				<li class="menu-accueil"> <a href="index.html">Accueil</a></li>
					<li class="menu-immo"> <a href="immo.html">Location Immobiliere</a></li>
					<li class="menu-randonne"> <a href="randonne.html">Location de matériel de randonnées</a></li>
				</ul>
			</nav>
...
Sexe : <br>
 ...
 <br><br>
	<center>
		...
		<div id= "contacter"> <!-- correspond au bas de la page--> 
